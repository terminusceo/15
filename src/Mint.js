...
function Mint() {
    ...
    const [feedback, setFeedback] = useState('Click to mint your De Factory.');
    ...
    const endTime = new Date('2023-08-19T16:00:00Z');
    ...
    return (
        <MintContainer>
            ...
            {isWalletConnected ? (
                <>
                    <AllocationContainer>
                        <AllocationTitle>Your Allocation</AllocationTitle>
                        <ListText>Whitelist: 0</ListText>
                        <ListText>Waitlist: 0</ListText>
                        <LimitText>Public mint limit: 5</LimitText>
                        <ListText>Available supply: {CONFIG.MAX_SUPPLY - data.totalSupply}/1111</ListText>
                    </AllocationContainer>
                ...
                <WhiteText>Please connect your wallet to mint De Factory.</WhiteText>
            )}
        </MintContainer>
    );
}
